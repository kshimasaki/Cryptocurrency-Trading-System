	...
	def evaluatePositions(self):
		...
		if (len(openTrades) < self.numSimulTrades):
			if (self.btc_historical_total <= 100000):
				...
				btc_historical_tweets, self.btc_sinceid = tweets.get_tweets(1000, self.btc_sinceID, bitcoin_query)
				...
				eth_historical_tweets, self.eth_sinceID = tweets.get_tweets(1000, self.eth_sinceID, ethereum_query)
